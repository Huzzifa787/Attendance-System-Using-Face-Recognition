...
class Developer:
    ...
    def __init__(self, root):
        ...
        # ==================== Title ============================
        title_lbl = Label(self.root, text="Welcome To Developer Page", font=(
        ...
        # ================== BUTTONS 1 ===========================
        std_img1_btn = Image.open(r"PICS\dep.jpeg")
        std_img1_btn = std_img1_btn.resize(
            (180, 200), Image.Resampling.LANCZOS)
        self.std_img1 = ImageTk.PhotoImage(std_img1_btn)

        b1 = Button(bg_img,command=self.fun1, image=self.std_img1, cursor="hand2",
                    borderwidth=0)
        b1.place(x=300, y=135, width=180, height=180)

        b1_1 = Button(bg_img,command=self.fun1, text="Muhammad Huzzifa",
        ...
        # ================== BUTTONS 2 ===========================
        std_img2_btn = Image.open(r"PICS\1.jpg")
        std_img2_btn = std_img2_btn.resize(
            (150, 200), Image.Resampling.LANCZOS)
        self.std_img2 = ImageTk.PhotoImage(std_img2_btn)

        b2 = Button(bg_img,command=self.fun, image=self.std_img2, cursor="hand2",
                    borderwidth=0)
        b2.place(x=600, y=135, width=180, height=180)

        b2_1 = Button(bg_img,command=self.fun, text="Abdul Rehman",
    ...
    def fun(self):
        self.new = 1
        self.url = "https://www.linkedin.com/in/hafiz-abdul-rehman-072a4a240"
        webbrowser.open(self.url,new=self.new)
    # ==================== FUNCTION =======================

    def fun1(self):
        self.new = 1
        self.url = "https://www.linkedin.com/in/huzaifa-hafeez-83b68321b/"
        webbrowser.open(self.url, new=self.new)
